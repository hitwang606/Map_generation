...
def publish_path(matrix,marker_vec1,marker_vec2,marker_vec3,ida):
    ...
    marker1.scale.x = size_scale
    marker1.scale.y = size_scale
    marker1.scale.z = size_scale
    ...
    marker2.scale.x = size_scale
    marker2.scale.y = size_scale
    marker2.scale.z = size_scale
    ...
    marker3.scale.x = size_scale
    marker3.scale.y = size_scale
    marker3.scale.z = size_scale
...
if __name__ == '__main__':
    ...
    file_path = os.path.join(script_dir, 'p_all_real.npy')
    # 从参数服务器获取矩阵参数
    drone_id = rospy.get_param('~ID')
    path_array = np.load(file_path)
    marker_vec1 = path_array[300:301,(drone_id-1)*3:drone_id*3].reshape(3,1)  # 转置以适应3xN格式
    marker_vec2 = path_array[1500:1501,(drone_id-1)*3:drone_id*3].reshape(3,1)  # 转置以适应3xN格式
    marker_vec3 = path_array[3219:3220,(drone_id-1)*3:drone_id*3].reshape(3,1)  # 转置以适应3xN格式
    matrix = path_array[300:3220,(drone_id-1)*3:drone_id*3].T  # 转置以适应3xN格式
